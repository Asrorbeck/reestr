        ...
        <div className="grid gap-6">
          ...
          <Card>
            <CardHeader>
              ...
              <CardDescription>Asosiy tizim parametrlari va konfiguratsiyasi</CardDescription>
            </CardHeader>
            <CardContent className="space-y-6">
              <div className="grid gap-4 md:grid-cols-2">
                <div className="space-y-2">
                  <Label htmlFor="system-name">Tizim nomi</Label>
                  <Input id="system-name" defaultValue="Markaziy Bank - Integratsiyalar Reestri" />
                </div>
                <div className="space-y-2">
                  <Label htmlFor="admin-email">Administrator email</Label>
                  <Input id="admin-email" type="email" defaultValue="admin@cbu.uz" />
                </div>
              </div>
              ...
              <div className="space-y-4">
                <div className="flex items-center justify-between">
                  <div className="space-y-0.5">
                    ...
                    <p className="text-sm text-muted-foreground">Eski integratsiyalarni avtomatik arxivlash</p>
                  </div>
                ...
                <div className="flex items-center justify-between">
                  <div className="space-y-0.5">
                    ...
                    <p className="text-sm text-muted-foreground">Barcha o'zgarishlarni yozib borish</p>
                  </div>
                  <Switch defaultChecked />
                </div>
              </div>
          ...
          <Card>
            <CardHeader>
              ...
              <CardDescription>Tizim hodisalari haqida bildirishnomalar</CardDescription>
            </CardHeader>
            <CardContent className="space-y-4">
              ...
              <div className="flex items-center justify-between">
                <div className="space-y-0.5">
                  ...
                  <p className="text-sm text-muted-foreground">Integratsiya xatoliklari haqida darhol xabar berish</p>
                </div>
                <Switch defaultChecked />
              </div>
              ...
              <div className="flex items-center justify-between">
                <div className="space-y-0.5">
                  ...
                  <p className="text-sm text-muted-foreground">Haftalik faoliyat hisobotini yuborish</p>
                </div>
                <Switch />
              </div>
            </CardContent>
          ...
          <Card>
            <CardHeader>
              ...
              <CardDescription>Tizim monitoring va performance sozlamalari</CardDescription>
            </CardHeader>
            <CardContent className="space-y-6">
              <div className="grid gap-4 md:grid-cols-2">
                <div className="space-y-2">
                  <Label htmlFor="check-interval">Tekshiruv intervali (daqiqa)</Label>
                  <Input id="check-interval" type="number" defaultValue="5" />
                </div>
                <div className="space-y-2">
                  <Label htmlFor="alert-threshold">Ogohlantirish chegarasi (%)</Label>
              ...
              <div className="space-y-4">
                <div className="flex items-center justify-between">
                  <div className="space-y-0.5">
                    ...
                    <p className="text-sm text-muted-foreground">Integratsiyalarni avtomatik tekshirish</p>
                  </div>
                  <Switch defaultChecked />
                </div>
                ...
                <div className="flex items-center justify-between">
                  <div className="space-y-0.5">
                    ...
                    <p className="text-sm text-muted-foreground">Tizim performance ma'lumotlarini yozib borish</p>
                  </div>
                  <Switch defaultChecked />
                </div>
              </div>
          ...
          <Card>
            <CardHeader>
              ...
              <CardDescription>Joriy tizim holati va versiya ma'lumotlari</CardDescription>
            </CardHeader>
            <CardContent className="space-y-4">
              <div className="grid gap-4 md:grid-cols-2">
                <div className="space-y-2">
                  ...
                  <div className="flex items-center gap-2">
                    ...
                    <span className="text-sm text-muted-foreground">Oxirgi yangilanish: 2024-03-15</span>
                  </div>
                </div>
                <div className="space-y-2">
