...
const statusColors = {
  ...
  rejalashtirilgan:
    "bg-[#f6f5e7] text-[#e4a216] dark:bg-[#3a3728] dark:text-[#e4a216]",
  ...
  useEffect(() => {
    const loadIntegration = async () => {
      ...
      try {
        ...
        const integration = await supabaseUtils.getIntegration(params.id);
    ...
    return (
      <div className="container mx-auto py-8">
        <div className="text-center">
          <div className="animate-spin rounded-full h-8 w-8 border-b-2 border-[#e4a216] mx-auto mb-4"></div>
            ...
            <Accordion type="single" collapsible className="w-full">
              {tab.files.map((file, index) => (
                <AccordionItem
                  ...
                  className="bg-sidebar dark:bg-sidebar border-b border-gray-200 dark:border-gray-700"
                >
                  <AccordionTrigger className="hover:no-underline hover:bg-[#f6f5e7] dark:hover:bg-[#3a3728] cursor-pointer transition-colors duration-200 px-4">
                    <div className="flex items-center justify-between w-full">
                      <div className="flex items-center space-x-3 text-left">
                        <FileText className="h-5 w-5 text-[#e4a216] flex-shrink-0" />
                        <div>
                      ...
                      <Button
                        ...
                        onClick={(e) => {
                          ...
                          if (file.url) {
                            ...
                            console.warn("File URL topilmadi");
                          }
                        }}
                        className="ml-4 hover:bg-[#f6f5e7] dark:hover:bg-[#3a3728] hover:border-[#e4a216] dark:hover:border-[#e4a216] hover:text-[#e4a216] dark:hover:text-[#e4a216]"
                      >
                        Yuklab olish
                      </Button>
                    </div>
          ...
          <div className="mb-6">
            <div className="flex items-center justify-between mb-4">
              <Button
                ...
                className="flex items-center gap-2 hover:!bg-[#f6f5e7] dark:hover:!bg-[#3a3728] hover:!text-[#e4a216] dark:hover:!text-[#e4a216]"
              >
                  ...
                  return (
                    <button
                      ...
                      className={cn(
                        ...
                        isActive
                          ? "border-[#e4a216] text-[#e4a216] dark:text-[#e4a216]"
                    ...
                    >
                      ...
                      {item.label}
                      {isActive && (
                        <span className="ml-2 w-2 h-2 bg-[#e4a216] rounded-full"></span>
                      )}
                    </button>
                  );
                })}
